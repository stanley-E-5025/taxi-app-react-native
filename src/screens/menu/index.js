  ...
  return (
    <SafeAreaView>
      <View style={styles.view1}>
        <Icon name="user-o" size={40} color="#000000" />
      </View>

      <View style={styles.infot}>
        <Text style={styles.text}>
          {' '}
          <Icon name="user-o" size={20} color="#000000" /> stanley gordon
        </Text>
      </View>
      ...
      <View style={styles.view2}>
        ...
        <View style={styles.infop}></View>
        <View style={styles.infos}>
          <Pressable style={styles.social} onPress={logear}>
          ...
          <Pressable style={styles.social}>
            <Icon name="whatsapp" size={30} color="#000000" />
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
